...
namespace Codenception.StairwayPatternArchitecture.Services
{
    ...
    {
        private readonly IMapper<IDomainRecord, IDatabaseRecord<System.ValueType>> _mappers;
        ...
        public RestaurantService(IQuery<IDatabaseRecord<System.ValueType>, System.ValueType> query, IEntity<IDomainRecord, IDomainRecord> restaurantEntity)
        {
            this._query = query;
